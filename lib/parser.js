  ...
  var result = {
    ...
    parse: function(input) {
      ...
      function parse_TMPL() {
        ...
        var savedPos1 = pos;
        var result16 = parse_BLOCK_START();
        if (result16 !== null) {
          var result17 = parse__();
          if (result17 !== null) {
            var result18 = parse_TMPL_COMMAND();
            if (result18 !== null) {
              var result19 = parse__();
              if (result19 !== null) {
                var result20 = parse_BLOCK_END();
                if (result20 !== null) {
        ...
        var result14 = result15 !== null
          ? (function(command) { return [command, {args: null, partial: null}]})(result15[2])
          : null;
        if (result14 !== null) {
          ...
          if (result3 !== null) {
            var result4 = parse__();
            if (result4 !== null) {
              var result5 = parse_TMPL_COMMAND();
              if (result5 !== null) {
                  ...
                  if (result7 !== null) {
                    ...
                    if (result8 !== null) {
                      ...
                      if (result9 !== null) {
                        ...
                        if (result10 !== null) {
                          var result2 = [result3, result4, result5, result6, result7, result8, result9, result10];
                        } else {
                          var result2 = null;
                          pos = savedPos0;
                        }
      ...
      function parse_BLOCK_INNER() {
        ...
        var result9 = result10 !== null
          ? (function(body) { return body})(result10)
          : null;
        if (result9 !== null) {
          var result0 = result9;
        } else {
          var result8 = parse_COMMAND();
          ...
          if (result7 !== null) {
            ...
            var result5 = result6 !== null
              ? (function(body) { return body})(result6)
              : null;
            if (result5 !== null) {
              var result0 = result5;
            } else {
              var result4 = parse_TMPL();
              var result3 = result4 !== null
                ? (function(body) { return body})(result4)
                : null;
              if (result3 !== null) {
                var result0 = result3;
              } else {
      ...
      function parse_BLOCK_ARGS() {
        ...
        if (result2 !== null) {
          var result3 = parse__();
          if (result3 !== null) {
            var result6 = parse_BLOCK_ARGS_INNER();
            if (result6 !== null) {
              var result4 = [];
              while (result6 !== null) {
