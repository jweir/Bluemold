  ...
  var result = {
    ...
    parse: function(input) {
      ...
      function parse_COMMAND() {
        ...
        var result0 = result1 !== null
          ? (function(command, body) { return [command, body.join("")]})(result1[2], result1[4])
          : null;
      ...
      function parse_BLOCK() {
        ...
        var savedPos1 = pos;
        var result9 = parse_BLOCK_HEAD();
        if (result9 !== null) {
          var result10 = parse_BLOCK_TAIL();
          if (result10 !== null) {
        ...
        var result7 = result8 !== null
          ? (function(head, tail) { return (head.command == tail) ? [head.command, head.body.join("")] : "error"})(result8[0], result8[1])
          : null;
        if (result7 !== null) {
          var result0 = result7;
        } else {
          var savedPos0 = pos;
          var result3 = parse_BLOCK_HEAD();
          if (result3 !== null) {
          ...
          var result1 = result2 !== null
            ? (function(head, inner, tail) { return (head.command == tail) ? [head.command, head.body.join(""), inner] : "error"})(result2[0], result2[1], result2[2])
            : null;
          if (result1 !== null) {
            var result0 = result1;
          } else {
      ...
      function parse_BLOCK_HEAD() {
        var cacheKey = "BLOCK_HEAD" + '@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_BLOCK_TAIL() {
        var cacheKey = "BLOCK_TAIL" + '@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result2 !== null) {
          var result3 = parse_BLOCK_COMMANDS();
          if (result3 !== null) {
            if (input.substr(pos, 2) === "}}") {
              var result4 = "}}";
              pos += 2;
        ...
        var result0 = result1 !== null
          ? (function(tail) { return tail })(result1[1])
          : null;
